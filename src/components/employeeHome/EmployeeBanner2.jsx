...
const EmployeeBanner2 = () => {
  return (
    <div className=" p-6 md:p-12 mt-8 rounded-lg shadow-lg">
      {/* Heading */}
      <SharedTitle heading="employee dashboard"></SharedTitle>
      {/* Calendar, Events, Notice */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Calendar Section */}
        <div className="bg-yellow-200 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
        ...
        {/* Events Section */}
        <div className="bg-yellow-200 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
          <FaBullhorn className="text-blue-600 text-4xl mb-3" />
